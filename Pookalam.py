...
for point in gen_points(radius - 2, 6, omega=5):
    cv2.floodFill(im,None, (point[0], point[1]), dark_orange)
...
for point in gen_points(radius -30, 6, omega=35):
    cv2.floodFill(im,None, (point[0], point[1]), white)
...
for point in gen_points(radius -90, 24, omega=35 ):
    cv2.floodFill(im,None, (point[0], point[1]), black)
